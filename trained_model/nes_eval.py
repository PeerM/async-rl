...
class Evaler(object):
    def __init__(self, rom, reward_type,reward_function_factory):
        super().__init__()
        def nes_factory():
            ...
            return NESInterface(rom,auto_render_period=60,reward_type=reward_type,reward_function_factory=reward_function_factory)
